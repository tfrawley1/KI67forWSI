...
#FMD800 is a 400x400 tile size
file_path = "W:\\python\\IHC_images\\FMD801_FMD-ITER5.40% CR_F.BALBcJ.46W_EUTH.11.04.2019_1.TUM_Ki-67.czi"
...
data = {'tile_name':tile_ID, 'viability':viable, 'dense_region':dense, 'positive_cell_count':posC_count, 'total_cell_count':allC_count}
df = pd.DataFrame(data)
#df.to_csv('W:\\FMD800_fourth_run.csv', index = False)
